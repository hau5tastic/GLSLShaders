...
void Model2::Render(const Matrix4 & projectionMatrix, const Matrix4 & viewMatrix, const Matrix3 & normalMatrix) const
{
...
void Model2::SetLightPos(const Vec3 & lightPos_)
{
	lightPos = lightPos_;
}
